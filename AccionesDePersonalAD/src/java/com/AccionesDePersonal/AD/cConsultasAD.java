...
public class cConsultasAD {
    ...
    public String strSQLInsertEyT(String explicacion, int tipo) {

        String nulo = "null";
        String numero_ap = "610.A.DTH.2010";
        Integer numero_tipo = tipo;
        String cedula = "0609874630";
        String resolucion = "RES-15";
        Calendar cal = Calendar.getInstance();
        ...
        String result = "INSERT INTO public.accion_personal(\n"
                ...
                + "            numero_ap, cedula_trabajador, numero_tipo, cedula_usuario, observaciones_ap, \n"
                + "            digitalizado_ap, rector_ap, director_th_ap)\n"
                + "    VALUES (' " + fecha + "', ' " + resolucion + "', ' " + fecha + "', ' " + explicacion + "', \n"
                + "            ' " + numero_ap + "', ' " + cedula + "'," + numero_tipo + ", ' " + nulo + "', ' " + nulo + "', \n"
                + "            ' " + nulo + "', ' " + nulo + "', ' " + nulo + "')";
        return result;
    }
