                ...
                <div id="contenidoDinamico" class="mt-1">
                    ...
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-xs-10">
                                <input class="form-control" type="text" placeholder="Número de Acción de Personal" id="example-text-input">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-xs-9">
                            ...
                            <div class="col-xs-3">
                                ...
                                <button type="button" id="" class="btn btn-secondary float-xs-right" data-toggle="tooltip" data-placement="top" title="Verificar Cédula">
